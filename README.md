...
The program shows how to parse through the JSON files and prepare the data for visualisation and analysis. For example, economic indicators such as the unemployment rate, CPI, GDP and current account balance are drawn out for visualisation. 
